document.addEventListener('DOMContentLoaded', function() {
            ...
            async function loadReviews(productId = '', userId = '') {
                try {
                    ...
                    if (productId || userId) {
                        url += `?${productId ? `productId=${productId}` : ''}${userId ? `&userId=${userId}` : ''}`;
                    }
            ...
            async function renderReviews(reviews) {
                ...
                reviews.forEach(review => {
                    ...
                    row.innerHTML = `
                        ...
                        <td class="review-text" title="${review.text || 'No text'}">${review.text || 'No text'}</td>
            ...
            function validateProductForm() {
                ...
                if (category.length < 2) {
                    document.getElementById('category-error').textContent = 'Category must be at least 2 characters';
